...
.downloadBtn img{
    width: 100%;
    filter: invert(100%) sepia(0%) saturate(5257%) hue-rotate(113deg) brightness(105%) contrast(100%);  
...
.downloadBtn.clicked{
    ...
    box-shadow: 0 0 25px #00CE7C;
}
.downloadBtn.clicked:active{
    box-shadow: 0 0 30px #00CE7C;
}
@keyframes mymove {
  from {
      background-color: var(--Yellow);
...
<div class="container">
    ...
    {/if}
    {#if clicked}
    <img src="./imgs/icons/success.svg" alt="success">
    {/if}
    </div>
        ...
        <div class="bottomPart">
                ...
                <div class="contactInfo">
                    ...
                    <div class="education section">
                        ...
                        <div class="singleEducation">
                            <div class="title">
                                {{
                                "fr" : "Bachelor de sciences en administration d'affaires",
                                "en" :"Bachelor of Science in Business Administration"
                                }[$lang]}</div>
                    ...
                    <div class="languages section">
                        ...
                        <div class="lang">
                            ...
                            <div class="langScore">
                                {#each Array(lng.score) as _,i}
                                <div class="completed"></div>
                                {/each}
                                {#each Array(5 - lng.score) as _,i}
            ...
            <div class="rightPart">
                <div class="aboutMe section">
                    ...
                    <div class="paragraph">
                        {{
                            "fr" :"Enthousiaste et motivé fraîchement diplômé en administration des affaires de TBS, Développeur Frontend ayant une longue expérience dans le secteur informatique avec toutes ses dimensions (Web, Mobile Apps, Web Scraping, Python automation, Youtube et création de contenu...etc), et plus que 3 ans d'expérience en tant que développeur web frontend en utilisant Svelte comme framework. Je suis à la recherche d'opportunités d'emploi qui m'aideront à améliorer mes compétences informatiques et à devenir un développeur frontend senior.",
                            "en" : "Enthusiastic and motivated freshly graduate in business administration from TBS, Frontend developer holding a lifelong experience in the IT sector with all its dimensions (Web, Mobile Apps, Web Scraping, Python automation, Youtube and content creation...etc), and more than 3 years of experience as frontend web developer using Svelte as framework. I am seeking job opportunities that help me improve my IT skills and be a senior frontend developer."}[$lang]}
                    </div>
                </div>
                <hr>
                ...
                <div class="work section">
                    <div class="title">
                        {{
                            "fr" : "L'expérience professionnelle",
                                "en" :"Work Experience"
                            }[$lang]}</div>
                    ...
                    <div class="singleWork">
                        <div class="companyDate">
                            <div class="workTitle">
                                {{"fr" : "Design graphique - Coach en développement Web",
                                "en" :"Graphic Design - Web development Coach"
                                }[$lang]}
                                 @MERIT TBS</div>
       ...
       <div class="bottomPart">
            <!-- <div class="leftPart">
                <div class="Links section">
                    ...
                    <ul>
                        <li>Linkedin : <a href="https://www.linkedin.com/in/ahmedbm27" target="_blank">/ahmedbm27</a></li>
                        <li>Github : <a href="https://github.com/ahmedbm27" target="_blank">/ahmedbm27</a></li>                    
                        <li>
                            {{
                                "fr" : "Site web : ",
                                    "en" :"Website : "
            ...
            <div class="rightPart">
                <div class="volunteer section">
                    <div class="title">
                        {{"fr" : "Expérience de bénévolat",
                        "en" :'Volunteer Experience'
                            }[$lang]}</div>
                    <div class="singlevolunteer">
                        <div class="project">
                            <div class="projectTitle">
                                {{"fr" : "Cérémonie de Diplôme ",
                        "en" :'Diploma Ceremony '
                            }[$lang]}( 10/2019 )</div>
                        </div>
                        <ul>
                    ...
                    <div class="singlevolunteer">
                        <div class="project">
                            <div class="projectTitle">
                                {{"fr" : "Formateur en montage vidéo ",
                        "en" :'Video Editing Trainer '
                            }[$lang]}
                                 ( 10/2018 )</div>
                        </div>
                        <ul>
                ...
                <div class="achievment section">
                    <div class="title">
                        ...
                        <div class="singlevolunteer">
                            <div class="project">
                                <div class="projectTitle">
                                    {{"fr" : "Camp de développement de jeu pour les jeunes",
                                    "en" :'Youth Game Development Camp'
                                }[$lang]}
                                    ( 09/2017 )</div>
                            </div>
                            <ul>
                                <li>
                                    {{"fr" : "Premier prix du meilleur jeu dans un camp organisé par ",
                                "en" :'First Award for the best game in a camp organized by '
                                }[$lang]}
                                <a href='https://gomycode.com/' target="_blank">GoMyCode</a>
                                {{"fr" : "et ",
                                "en" :'and '
                                }[$lang]}
